    ...
    <div>
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* text section */}
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px] text-center md:text-left">
            <motion.h1
            ...
            >
              Discover smart tips and elegant solutions to transform your living space into a cozy, modern haven — effortlessly.
              {" "}
            </motion.p>
            <motion.div
          ...
          <div className="flex flex-col justify-center overflow-hidden">
            <motion.img
              ...
              src={banner2}
              alt=""
              className="w-[180%] md:w-[150%] lg:w-[150%]"
            />
          </div>
        </div>
      </div>
